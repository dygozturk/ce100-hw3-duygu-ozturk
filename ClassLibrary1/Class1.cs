...

{
    public class Class1
    {
       ...
       * 
       * @param [in] fiR, fiS[\b String]  function index of  in the serie
       * 
       * @param [in] a, e [\b int] function index of  in the serie
       * 
       ...
       **/
        ...
        * 
        * @param [in] fiA, i, j [\b int[]]  function index of  in the serie
        * 
